...
# | |(_) |__> \_/\_/(/_ |  |  | (_)\^/
#
# macdoNet.py created December 1st 2020
...
class DeepQNetwork(nn.Module):
    def __init__(self, ALPHA, input_dims,
        ...
        self.conv1 = nn.Conv1d(1,3,3,1,2)
        self.conv2 = nn.Conv1d(3,6,3,1,2)
        self.conv3 = nn.Conv1d(6,9,3,1,2) 
        
        self.fc1 = nn.Linear(9*22, 512) 
    ...
    def forward(self, observation):
        ...
        #print("obs size:", observation.size())
        observation = observation.view(-1,1,16)
        #print("obs size2 :",observation.size())
        observation = F.relu(self.conv1(observation))
        observation = F.relu(self.conv2(observation))
        observation = F.relu(self.conv3(observation))
        observation = observation.view(-1, 9*22)
